...
data "archive_file" "the_lambda_function" {
  ...
  source_dir  = "${path.cwd}/microservices/${var.lambda_func_name}/source_code"  
  output_path = "${path.cwd}/microservices/${var.lambda_func_name}/last_deploy/${var.lambda_func_name}.zip"
