...
import (
	...
	"github.com/juanmanuel0963/golang_aws_terraform_jenkins/v2/microservices_restful_ec2/source_code/controllers"
...
func main() {
	...
	r.PUT("/post_update/:id", controllers.PostUpdate)
