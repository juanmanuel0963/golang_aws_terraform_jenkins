...
## Jenkins
The platform update instructions and the Golang code can be automatically deployed with Terraform commands or thorught Jenkins Pipelines to DEV, QAT or PROD environments.
